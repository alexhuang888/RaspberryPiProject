...
if("TRUE" STREQUAL "TRUE")
  set(ORB_SLAM_SOURCE_PREFIX /home/alex/RaspberryPiProject/rosbuild_ws/src/ORB_SLAM)
  set(ORB_SLAM_DEVEL_PREFIX /home/alex/RaspberryPiProject/rosbuild_ws/devel)
  set(ORB_SLAM_INSTALL_PREFIX "")
  set(ORB_SLAM_PREFIX ${ORB_SLAM_DEVEL_PREFIX})
else()
  set(ORB_SLAM_SOURCE_PREFIX "")
  set(ORB_SLAM_DEVEL_PREFIX "")
  set(ORB_SLAM_INSTALL_PREFIX /home/alex/RaspberryPiProject/rosbuild_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ORB_SLAM' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'alex <alex@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ORB_SLAM' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alex/RaspberryPiProject/rosbuild_ws/src/ORB_SLAM/${idir}'.  Ask the maintainer 'alex <alex@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ORB_SLAM_dep}_FOUND)
      find_package(${ORB_SLAM_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ORB_SLAM_dep} REQUIRED ${depend_list})
  endif()
