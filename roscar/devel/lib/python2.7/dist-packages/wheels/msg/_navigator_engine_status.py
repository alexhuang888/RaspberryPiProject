"""autogenerated by genpy from wheels/navigator_engine_status.msg. Do not edit."""
import sys
...
class navigator_engine_status(genpy.Message):
  _md5sum = "b58306f136fb7e7ce1f37a683a5ac9f4"
  _type = "wheels/navigator_engine_status"
...
"""
  __slots__ = ['header','nActiveEngineID','strActiveEngineDescription']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,nActiveEngineID,strActiveEngineDescription
    ...
    """
    if args or kwds:
      super(navigator_engine_status, self).__init__(*args, **kwds)
